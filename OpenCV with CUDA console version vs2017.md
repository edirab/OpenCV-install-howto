...
Описание следует данной статье: https://habr.com/ru/post/464015/

## Использовались:

- CMake 3.18.2 (console)
- opencv 4.1.1
...
- Python 3.7.3
- Python 2.7.16
- MS Visual Studio 2017 Enterprise Edition

Дополнительно были установлены 
+ openjpeg-v2.3.1-windows-x64

NB:

1. При установке Python 3 необходимо выбрать установку с отладочной информацией 
(появится `C:/Python37/libs/python37_d.lib`)
2. Файлы из архива CuDNN необходимо перенести в `C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.0\bin` 
(туда, куда был установле CUDA)
3. Мне пришлось удалить и переустановить Anaconda3, поскольку в глобальном окружении были установлены несколько opencv-python
и в процессе компиляции хедеры подтягивались именно оттуда
...
set "python3_library_debug=C:/Python37/libs/python37_d.lib"
...
--
--   Platform:
--     Timestamp:                   2020-08-31T19:55:56Z
...
--     C++ Compiler:                C:/Program Files (x86)/Microsoft Visual Studio/2017/Enterprise/VC/Tools/MSVC/14.16.27023/bin/Hostx86/x64/cl.exe  (ver 19.16.27041.0)
...
--     Unavailable:                 cnn_3dobj cvv dnn freetype hdf java js matlab ovis sfm viz
...
> При неудачной генерации или наличии ошибок после выполнения команды, 
> повторную генерацию следует производить вычистив все файлы в build/ и .cache/.